...
const Dock = ({ windowsState, setWindowsState }) => {
    return (
        <footer className='dock'>
            ...
            <div onClick={() => { setWindowsState(state => ({ ...state, note: true })) }} className='icon note'>
            ...
            <div onClick={() => { window.open("mailto:aakshat11g@example.com", "_blank") }} className='icon mail'>
                <img src="/doc-icons/mail.svg" alt="" />
            </div>
            <div onClick={() => { window.open("https://www.linkedin.com/in/akshat-gupta-238664297/", "_blank") }} className='icon link'>
                <img src="/doc-icons/link.svg" alt="" />
            </div>
            <div onClick={() => { setWindowsState(state => ({ ...state, cli: true })) }} className='icon cli'>
